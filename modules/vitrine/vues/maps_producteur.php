...
<div class="alert alert-info alert-dismissible">
    ...
    <strong>Info!</strong> Choisissez vos points de ventes favories où vous viendrez distribuer vos produits.
  </div>
<?php 
}
 else
...
<?php
 ...
 ?>
<a href="index.php?module=vitrine&action=produire" type="button" class="btn peach-gradient btn-lg">Proposer des lots</a>
...
<script type="text/javascript">
    ...
    for (i = 0; i < locations.length; i++) {  
      ...
      (function(marker, i) {
            ...
            '<p> <a class="nav-link" href=\'index.php?module=vitrine&action=maps_producteur&point=' + locations[i].idPoint +'\'>Ajouter au favoris</a>'+
            '</td>'+
            '<td>'+
