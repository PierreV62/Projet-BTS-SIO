<!--section-->
<?php 
include 'global/maintenance.php';
?>
<div class="row">
	    ...
	    <hr>
	    <div class="row col-lg-12" id="TexteGauche">
	    	<!--carte producteur-->	
	        ...
	        <div class="card-block">
	          ...
	          <a class="btn btn-default" href="index.php?module=utilisateur&action=inscription&role=producteur">S'inscrire</a>
	        </div>
	      ...
	      <div class="card col-xs-12 card-info text-center  col-lg-3 offset-lg-1 offset-md-1">
	          ...
	          <a class="btn btn-default" href="index.php?module=utilisateur&action=inscription&role=client">S'inscrire</a>
	        </div>
	        <div class="card-footer text-muted default-color-dark white-text">
	      ...
	      <div class="card col-xs-12 default-color text-center  col-lg-3 offset-lg-1 offset-md-1">
	        ...
	        <div class="card-block">
          	...
          	<a class="btn btn-default" href="index.php?module=utilisateur&action=inscription&role=artisan">S'inscrire</a>
	        </div>
	        <div class="card-footer text-muted default-color-dark white-text">
		...
		<!--Card-->
	  	<div class="card">
	    	<!--Card image-->
	    	<img class="img-fluid" src="images/vitrine/jardinier.jpg" alt="jardinier">
	    ...
	    <div class="card">
	    	<!--Card image-->
	    	<img class="img-fluid" src="images/vitrine/repas.jpg" alt="Hommes/femmes">

	    	<!--fin de la Card image-->
	    	<!--Card content-->
	    	<div class="card-block">
		    	<!--Title-->
		    	<h4 class="card-title">Hommes/femmes</h4>
		        <!--Text-->
		        <p class="card-text">Eco consommateurs responsables, ils cuisinent des produits de saison, Ils rêvent d'une terre et d'hommes respectés.</p>
		    </div>
		    <!--fin de la Card content-->
	    </div>
	    <!--fin de la Card-->
	    ...
	    <div class="card">
	    	<!--Card image-->
	      <img class="img-fluid" src="images/vitrine/boucher.jpg" alt="boucher">
	      <!--fin de la Card image-->
	      <!--Card content-->
	      <div class="card-block">
	  	    <!--Title-->
